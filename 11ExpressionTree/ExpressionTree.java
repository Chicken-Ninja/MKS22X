public class ExpressionTree{
  ...
  public String toString(){
    /*you are to write this method*/
      String dump = "";
      if(isOp() == false && isValue() == true)
	  {
	      return "" + getValue();
	  }
      else{
	  dump = dump + "(" + " " + getLeft().toString()+ " "  + getOp() + " " + getRight().toString() + ")";
      }
      return dump;
  ...
  public String toStringPostfix(){
    /*you are to write this method*/
	  ...
	  {
	      return dump + getLeft().toStringPostfix() + " " + getRight().toStringPostfix() + " " + getOp();
	  }
  }
  ...
  public String toStringPrefix(){
    /*you are to write this method*/
	  ...
	  {
	      return dump + " " + getOp() + " " +  getLeft().toStringPrefix() + " " + getRight().toStringPrefix();
	  }
  }
