public class MyLinkedListImproved<T> implements interfaceThatHas<T>
{
	...
	if(last == null)
	    {
		Node a = new Node<T>(null, null, value);
		last = a;
		first = a;
	...
	///  }
	    ...
	    Node c = new Node<T>(null, last, value);
	    last.setNext(c);
	    last = c;
	}
	length++;
	...
	if(Index > length) 
	    ...
	    {
		Node a = new Node<T>(first , null, value);
		first.setPrev(a); 
		first = a;
		length++;
	    }
	    ...
	    {
		Node a = new Node<T>(null, last, value); 
		last.setNext(a);
		last = a; 
		length++;
	    }
	    ...
	    for(int counter = 1; counter <= length; counter++) 
		{
		    if(counter == Index) 
			{
			    Node a = new Node<T>(tempNext , temp , value);
			    temp.setNext(a);
			    tempNext.setPrev(a);
